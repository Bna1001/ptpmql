...
namespace baithuchanh2003.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Students.Include(s => s.Faculty);
        ...
        public async Task<IActionResult> Create([Bind("StudentCode,FullName,Address,FacultyID")] Student student)
        {
